...
import { ArrowLeft, Edit, Trash2, Package, DollarSign, ShoppingCart, Truck } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 w-full">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="font-medium text-foreground mb-2">Date Created</span>
                  </div>
            ...
            <div className="bg-background text-foreground p-6 rounded-lg border shadow-sm">
              ...
              <div className='flex items-center gap-x-5'> <div><h3 className="font-medium">Order Status</h3>
                <Badge className={statusColors[order.status] || 'text-background'}>
                  {order.status.charAt(0).toUpperCase() + order.status.slice(1)}
                </Badge></div>
                <div> <h3 className="font-medium text-foreground">Payment Status</h3>
                  <Badge
                    className={
        ...
        <div className="bg-background text-foreground p-6 rounded-lg border shadow-sm mt-6">
          ...
          <div className="mt-6 pt-4 border-t">
            ...
            <div className="text-sm text-gray-600">
              Items: {order.items?.map(item => `${item.productId?.productName} x ${item.quantity}`).join(', ')}
            </div>
            <div className="text-sm text-gray-600">
            <span>
