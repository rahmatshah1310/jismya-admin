...
export default function BannerTable({ title, banners,handleViewBanner,handleReorderBanner,handleDeleteBanner,handleEditBanner }) {
    return (
                        ...
                        {banners?.map(banner => (
                            <tr key={banner._id} className="border-t">
                                ...
                                <td className="p-2 min-w-[350px] space-x-2">
                                    ...
                                    <Button onClick={() => { handleEditBanner(banner); }} className="px-2 py-1 bg-blue-500 text-white rounded ">Edit</Button>
                                    <Button onClick={() => handleReorderBanner(banner)} className="px-2 py-1 bg-yellow-500 text-white rounded">
                                        Reorder
                                    </Button>
                                    <Button onClick={() => handleDeleteBanner(banner._id)} className="px-2 py-1 bg-red-500 text-white rounded">Delete</Button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
